...
export default function Tree({ chats, selectedChat, setSelectedChat, setShowChat,
  selectedGraph, loading, supabase, onChatsUpdate, onGraphsUpdate, setSelectedGraph,
  onGraphsRefresh
}) {
